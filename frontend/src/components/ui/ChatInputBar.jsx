...
/** 技能列表：快速、MCP、SUI（看见 UI）、自主拆解任务、Agent 执行等 */
const DEFAULT_SKILLS = [
  { id: 'quick', icon: iconQuick, label: '快速', tag: null, tagType: 'beta' },
  { id: 'mcp', icon: iconMcp, label: 'MCP', tag: null, tagType: 'beta' },
  { id: 'sui', icon: iconSui, label: 'SUI', tag: null, tagType: 'beta' },
  { id: 'task-decompose', icon: iconTaskDecompose, label: '拆解', tag: null, tagType: 'beta' },
  { id: 'agent', icon: iconAgent, label: 'Agent', tag: null, tagType: 'beta' },
];
